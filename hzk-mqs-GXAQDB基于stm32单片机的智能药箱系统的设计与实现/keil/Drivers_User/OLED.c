...
#include "stdlib.h"          // 标准库头文件（如果使用了相关函数）
#include "string.h"          // 字符串操作头文件（如果使用了相关函数）
#include "delay.h"
...
void oled_test(void)
{
	...
	OLED_ShowString(16, 18, "Hello World!666", OLED_6X8);
	
//	/*在(0, 28)位置显示数字12345，长度为5，字体大小为6*8点阵*/
//	OLED_ShowNum(0, 28, 12345, 5, OLED_6X8);
	
	cnt++;
	OLED_ShowHexNum(0, 28, cnt, 5, OLED_6X8);
