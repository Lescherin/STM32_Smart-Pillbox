...
(function(vue) {
  ...
  const DB = {
    ...
    getTable(dbTable) {
      return new Promise((resolve, reject) => {
        plus.sqlite.selectSql({
          ...
          fail(e) {
            formatAppLog("log", "at utils/sqlite.js:68", e);
            reject(e);
          }
        });
      });
    ...
    QueryAllTables() {
      return new Promise((resolve, reject) => {
        plus.sqlite.selectSql({
          ...
          fail(e) {
            formatAppLog("log", "at utils/sqlite.js:89", e);
            reject(e);
          }
        });
      });
    ...
    selectTableName() {
      return new Promise((resolve, reject) => {
        plus.sqlite.selectSql({
          ...
          fail(e) {
            formatAppLog("log", "at utils/sqlite.js:110", e);
            reject(e);
          }
        });
      });
    ...
    // 	  .catch((error) => {
    // 	    __f__('log','at utils/sqlite.js:135','失败', error)
    // 	  })
    // })
  ...
  const _sfc_main$6 = {
    ...
    setup(__props, { expose: __expose }) {
      __expose();
      const isLoginMode = vue.ref(true);
      const username = vue.ref("");
      const password = vue.ref("");
      const confirmPassword = vue.ref("");
      const isLoading = vue.ref(false);
      const resetPasswordVisible = vue.ref(false);
      ...
      const __returned__ = { isLoginMode, username, password, confirmPassword, isLoading, resetPasswordVisible, isFormValid, toggleMode, handleSubmit, handleLogin, handleRegister, handleForgotPassword, ref: vue.ref, computed: vue.computed, onMounted: vue.onMounted, get DB() {
        return DB;
      } };
  ...
  function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "login" }, [
      vue.createElementVNode("view", { class: "login-container" }, [
        vue.createElementVNode("view", { class: "login_top" }, [
          vue.createElementVNode(
            "text",
            null,
            vue.toDisplayString($setup.isLoginMode ? "欢迎回来" : "注册账号"),
            1
            /* TEXT */
          ),
          vue.createElementVNode(
            "text",
            { class: "subtitle" },
            vue.toDisplayString($setup.isLoginMode ? "请登录您的账户" : "请创建您的账户"),
            1
            /* TEXT */
          )
        ]),
        vue.createElementVNode("view", { class: "login_body" }, [
          vue.createElementVNode("view", { class: "login_input" }, [
            ...
            !$setup.isLoginMode ? (vue.openBlock(), vue.createElementBlock("view", {
              key: 0,
              class: "input-group"
            }, [
            ...
            vue.createElementVNode("view", { class: "submit-btn" }, [
              ...
              }, vue.toDisplayString($setup.isLoginMode ? "登 录" : "注 册"), 9, ["disabled", "loading"])
            ]),
            vue.createElementVNode("view", { class: "login-links" }, [
              vue.createElementVNode(
                "text",
                {
                  class: "link",
                ...
                vue.toDisplayString($setup.isLoginMode ? "没有账号？注册" : "已有账号？登录"),
                1
                /* TEXT */
              ),
              $setup.isLoginMode ? (vue.openBlock(), vue.createElementBlock("text", {
                key: 0,
                class: "link",
  ...
  const PagesLoginLogin = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__file", "C:/Users/Administrator/Desktop/hzk-mqs-GXAQDB基于stm32单片机的智能药箱系统的设计与实现/app/pages/login/login.vue"]]);
  ...
  (function(module, exports) {
    (function(f) {
      ...
      return (/* @__PURE__ */ function() {
        ...
        function buildBuilder(mqttClient2, opts) {
          var connection;
  ...
  const config = {
    ...
    mqtt: {
      ...
      topic: "hznyxxt2025114",
      // 接收数据的主题
      topic_ctrl: "hznyxxt2025114_ctrl",
      // 发送控制指令的主题
      qos: 0,
      // QoS等级（0/1/2）
      clientId: "uniapp-client-" + Math.random().toString(36).substring(2, 10),
      // 随机客户端ID
      username: "root",
      // 用户名
      password: "root",
      ...
      connectTimeout: 1e4,
      // 10秒连接超时
      stm32_Olnine_time: 3e3,
      // 此处在判定单片机多久未发送mqtt视为离线状态 单位毫秒
      controlInterval: 1e3
      // 控制指令间隔时间（毫秒）
    },
  ...
  const thresholdManager = {
      ...
      try {
        ...
        for (const key in thresholds) {
          if (Object.prototype.hasOwnProperty.call(thresholds, key)) {
            ...
            if (max < min) {
              formatAppLog("error", "at utils/thresholdManager.js:61", `设备${key}阈值设置无效: max=${max} < min=${min}`);
              continue;
            }
        ...
        formatAppLog("error", "at utils/thresholdManager.js:77", "保存阈值失败:", error);
        return false;
      }
    },
    /**
    ...
    getThresholds() {
      ...
      try {
        ...
        formatAppLog("error", "at utils/thresholdManager.js:97", "获取阈值失败:", error);
        return {};
      }
    },
    /**
    ...
    updateThreshold(deviceKey, values) {
      ...
      if (max < min) {
        formatAppLog("error", "at utils/thresholdManager.js:122", `设备${deviceKey}阈值设置无效: max=${max} < min=${min}`);
        return false;
      }
    ...
    checkThreshold(deviceKey, value) {
      ...
      try {
        if (typeof value === "string") {
          const numericStr = (_a2 = value.match(/-?\d+(?:\.\d+)?/)) == null ? void 0 : _a2[0];
        ...
        formatAppLog("error", "at utils/thresholdManager.js:187", "阈值检查失败:", error);
        return null;
      }
      ...
      if (numValue > max + this.tolerance) {
        return {
          type: "over",
          message: ((_b = device.alarmMessage) == null ? void 0 : _b.over) || `${device.label}超过阈值`,
          deviceKey,
          value: numValue,
          threshold: max,
      ...
      if (numValue < min - this.tolerance) {
        return {
          type: "under",
          message: ((_c = device.alarmMessage) == null ? void 0 : _c.under) || `${device.label}低于阈值`,
          deviceKey,
          value: numValue,
          threshold: min,
          deviceName: device.label,
  ...
  const alarmManager = {
    ...
    // 控制指令间隔时间
    controlInterval: ((_a = config.mqtt) == null ? void 0 : _a.controlInterval) || 1e3,
    /**
     * 向队列添加控制命令
    ...
    processControlQueue() {
      ...
      formatAppLog("log", "at utils/alarmManager.js:44", `发送控制命令到${deviceLabel}:`, message);
    ...
    checkAndAlarm(data) {
      ...
      if (!data || typeof data !== "object") {
        formatAppLog("error", "at utils/alarmManager.js:66", "无效的MQTT数据格式:", data);
        return;
      }
    ...
    getTriggeredDevicesInfo(deviceKey, type) {
      ...
      const linkageConfig = (_a2 = config.deviceLinkageConfig) == null ? void 0 : _a2[deviceKey];
      if (!linkageConfig || !linkageConfig[type]) {
        return controlDevices;
      }
      for (const controlDeviceConfig of linkageConfig[type]) {
        const controlDevice = (_b = config.devices_ctrl) == null ? void 0 : _b.find((ctrl) => ctrl.key === controlDeviceConfig.key);
        if (controlDevice) {
          controlDevices.push({
    ...
    showAlarmDialog(alarmInfo, triggeredDevices) {
      ...
      const device = (_a2 = config.devices) == null ? void 0 : _a2.find((d) => d.key === deviceKey);
      const symbol = type === "over" ? "↑" : "↓";
      let controlInfo = "";
      if (triggeredDevices && triggeredDevices.length > 0) {
        controlInfo = "\n\n系统已自动触发以下控制设备:\n";
        triggeredDevices.forEach((device2) => {
          controlInfo += `- ${device2.label} (${device2.action === "on" ? "开启" : "关闭"})
`;
        });
      ...
      uni.showModal({
        title: `【${triggeredDevices.length > 0 ? "自动控制已触发" : "报警提醒"}】${(device == null ? void 0 : device.label) || deviceKey} 报警`,
        content: `${(device == null ? void 0 : device.label) || deviceKey} ${symbol}
当前值: ${value}
设定阈值: ${threshold}
...
是否需要关闭报警？`,
    ...
    triggerControlDevice(deviceKey, type) {
      ...
      for (const controlDeviceConfig of controlDevices) {
        ...
        if (controlDevice && controlDevice.mqttConfig) {
          const message = controlDeviceConfig.action === "on" ? controlDevice.mqttConfig.onMessage : controlDevice.mqttConfig.offMessage;
          if (message) {
    ...
    deactivateControlDevice(deviceKey) {
      ...
      if (controlAlarmInfo && controlAlarmInfo.controlDevices) {
        for (const controlDeviceInfo of controlAlarmInfo.controlDevices) {
          ...
          const message = action === "on" ? (_a2 = controlDevice == null ? void 0 : controlDevice.mqttConfig) == null ? void 0 : _a2.onMessage : (_b = controlDevice == null ? void 0 : controlDevice.mqttConfig) == null ? void 0 : _b.offMessage;
  ...
  const mqtt_config = vue.ref({});
  mqtt_config.value = { ...config.mqtt };
  const mqttClient = vue.ref(null);
  const connectStatus = vue.ref(false);
  const Stm32Status = vue.ref(false);
      ...
      try {
        ...
        mqttClient.value.on("connect", (connack) => {
          ...
          mqttClient.value.on("message", (topic, message) => {
            try {
              formatAppLog("log", "at utils/mqtt_util.js:90", "接收到MQTT消息 - 主题:", topic, "内容:", message.toString());
              const data = JSON.parse(message.toString());
              Stm32Status.value = data.code == topic ? true : false;
              alarmManager.checkAndAlarm(data);
              resetTimeout();
            } catch (error) {
              formatAppLog("error", "at utils/mqtt_util.js:99", "全局解析MQTT消息失败:", error);
              formatAppLog("log", "at utils/mqtt_util.js:101", "接收到的原始消息:", message.toString());
            }
          });
          resolve(connack);
        });
        ...
        mqttClient.value.on("reconnect", () => {
          formatAppLog("log", "at utils/mqtt_util.js:121", "MQTT重连中...");
        });
      } catch (error) {
        reject(error);
      }
  ...
  function mqtt_subscribe() {
    ...
    mqttClient.value.subscribe(
      ...
      (err) => {
        if (err) {
          formatAppLog("error", "at utils/mqtt_util.js:145", "订阅主题失败:", err);
        } else {
          formatAppLog("log", "at utils/mqtt_util.js:147", "订阅主题成功");
        }
      }
    );
  }
  function mqtt_publish(message) {
    ...
    mqttClient.value.publish(
      ...
      (err) => {
        if (err) {
          formatAppLog("error", "at utils/mqtt_util.js:172", "payload+发布主题失败:", err);
        } else {
          formatAppLog("log", "at utils/mqtt_util.js:174", payload + "发布主题成功");
        }
      }
    );
  }
  ...
  const historyManager = {
    ...
    saveHistoryData(data) {
      try {
        ...
        formatAppLog("error", "at utils/historyManager.js:39", "保存历史数据失败:", error);
        return false;
      }
    },
    /**
    ...
    getHistoryData() {
      try {
        ...
        formatAppLog("error", "at utils/historyManager.js:52", "获取历史数据失败:", error);
        return [];
      }
    },
    /**
    ...
    formatDateTime(timestamp) {
      try {
        ...
        formatAppLog("error", "at utils/historyManager.js:94", "格式化日期时间失败:", error);
        return "";
      }
    },
    /**
    ...
    clearHistoryData(days = 0) {
      try {
        ...
        formatAppLog("error", "at utils/historyManager.js:127", "清除历史数据失败:", error);
        return false;
      }
    }
  };
  ...
  const _sfc_main$5 = {
      ...
      valueRange: {
        ...
        validator: (val) => {
          ...
          if (typeof val[2] !== "number")
            return false;
          if (!/^(10*|0?\.0*1|1e-[1-9]\d*)$/.test(String(val[2])))
            return false;
          return true;
        }
      },
    ...
    computed: {
      ...
      knobSizeFixed() {
        if (this.knobSize <= 1)
          return this.knobSize * this.size;
    ...
    methods: {
      syncModelValue() {
        ...
        const anglePos = (this.endFixed - this.startFixed) * pos + this.startFixed;
        this.currentPos = anglePos;
        this.$nextTick(() => {
          this.updatePosition();
        });
      ...
      updateCenter() {
        ...
        query.select(".zui-knob-basic-wrapper").fields({ size: true, rect: true }).exec((rst) => {
          if (!rst)
            return;
          if (!rst[0])
            return;
      ...
      fireEvent(change) {
        ...
        if (this.hasRange) {
          value = (this.positionFixed - this.startFixed) / (this.endFixed - this.startFixed);
        }
  ...
  function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "zui-knob-basic" }, [
      vue.createElementVNode(
        "view",
        {
          ref: "eleWrapper",
          class: vue.normalizeClass({ "zui-knob-basic-wrapper": 1, debug: $props.debug }),
          style: vue.normalizeStyle($options.style)
        },
        [
          vue.createElementVNode("div", { class: "background" }, [
            vue.createElementVNode("image", {
              class: "base-img",
              src: $props.theme.base,
              mode: "aspectFit"
            }, null, 8, ["src"])
          ]),
          vue.createElementVNode(
            ...
            {
              class: "handle",
              onTouchstart: _cache[0] || (_cache[0] = vue.withModifiers((...args) => $options.dragStart && $options.dragStart(...args), ["prevent"])),
              onTouchmove: _cache[1] || (_cache[1] = vue.withModifiers((...args) => $options.dragMoving && $options.dragMoving(...args), ["prevent"])),
              onTouchcancel: _cache[2] || (_cache[2] = vue.withModifiers((...args) => $options.dragCancel && $options.dragCancel(...args), ["prevent"])),
              onTouchend: _cache[3] || (_cache[3] = vue.withModifiers((...args) => $options.dragEnd && $options.dragEnd(...args), ["prevent"]))
            },
            [
              vue.createElementVNode("image", {
                class: "knob-img",
                src: $props.theme.handle,
                mode: "aspectFit"
              }, null, 8, ["src"])
            ],
            32
          ...
          $props.debug ? (vue.openBlock(), vue.createElementBlock("view", {
            key: 0,
            class: "debug-frame"
          }, [
            vue.createElementVNode("view", { class: "anchor" }),
            vue.createElementVNode("view", { class: "real-anchor" }),
  ...
  const ZuiKnobBasic = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__scopeId", "data-v-75690899"], ["__file", "C:/Users/Administrator/Desktop/hzk-mqs-GXAQDB基于stm32单片机的智能药箱系统的设计与实现/app/uni_modules/zui-knob-basic/components/zui-knob-basic/zui-knob-basic.vue"]]);
  const _sfc_main$4 = {
    __name: "index",
    setup(__props, { expose: __expose }) {
      __expose();
      const dataItems = vue.ref(config.devices);
      const ctrlItems = vue.ref(config.devices_ctrl);
      const knobItems = vue.ref(config.knobItems);
      const latestMqttData = vue.ref({});
      const isProcessing = vue.ref(false);
      const tempKnobValues = vue.ref({});
      const lastKnobValues = vue.ref({});
      vue.onMounted(() => {
        mqtt_connect().then(() => {
          mqttClient.value.on("message", (topic, message) => {
          ...
          formatAppLog("error", "at pages/index/index.vue:92", "MQTT连接失败:", err);
        });
      });
      function handleMqttMessage(message) {
        try {
          ...
          formatAppLog("error", "at pages/index/index.vue:123", "解析MQTT消息失败:", e);
        }
      }
      ...
      function handleKnobChange(item) {
        ...
        if (lastKnobValues.value[item.label] !== currentValue) {
          ...
          if ((_a2 = item.mqttConfig) == null ? void 0 : _a2.Message) {
      ...
      function hasThresholdConfig(item) {
        return item.thresholdMin !== void 0 && item.thresholdMax !== void 0;
      }
      ...
      const __returned__ = { dataItems, ctrlItems, knobItems, latestMqttData, isProcessing, tempKnobValues, lastKnobValues, handleMqttMessage, getCtrlItemStatus, toggleSwitch, handleSwitchChange, handleKnobUpdate, handleKnobChange, hasThresholdConfig, getDataProgress, getProgressStatusClass, ref: vue.ref, onMounted: vue.onMounted, onUnmounted: vue.onUnmounted, get mqttClient() {
        return mqttClient;
      }, get connectStatus() {
  ...
  function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "wrap" }, [
      vue.createElementVNode("view", { class: "oled-container" }, [
        vue.createElementVNode("view", { class: "oled-title" }, [
          vue.createElementVNode("text", { class: "title-icon" }, "🖥"),
          vue.createElementVNode("text", null, "OLED显示屏")
        ]),
        vue.createElementVNode("view", { class: "oled-screen" }, [
          vue.createElementVNode("view", { class: "oled-data-section" }, [
            (vue.openBlock(true), vue.createElementBlock(
              vue.Fragment,
              null,
              vue.renderList($setup.dataItems, (item, index) => {
                return vue.openBlock(), vue.createElementBlock("view", {
                  class: "oled-line",
                  key: "oled-" + index
                }, [
                  vue.createElementVNode("view", { class: "oled-data-row" }, [
                    vue.createElementVNode(
                      "text",
                      { class: "oled-text" },
                      vue.toDisplayString(item.label) + ": " + vue.toDisplayString(item.value),
                      1
                      /* TEXT */
                    ),
                    $setup.hasThresholdConfig(item) ? (vue.openBlock(), vue.createElementBlock("view", {
                      key: 0,
                      class: "oled-progress-container"
                    }, [
                      vue.createElementVNode("view", { class: "oled-progress-bar" }, [
                        vue.createElementVNode(
                          "view",
                          {
                            class: vue.normalizeClass(["oled-progress-fill", $setup.getProgressStatusClass(item)]),
                            style: vue.normalizeStyle({ width: $setup.getDataProgress(item) + "%" })
                          },
                          null,
                          6
                          /* CLASS, STYLE */
            ...
            vue.createElementVNode("view", { class: "oled-line" }, [
              vue.createElementVNode(
                "text",
                { class: "oled-text" },
                "单片机状态: " + vue.toDisplayString($setup.Stm32Status ? "在线" : "离线"),
                1
                /* TEXT */
              )
            ])
          ]),
          vue.createElementVNode("view", { class: "oled-divider" }),
          vue.createElementVNode("view", { class: "oled-control-section" }, [
            (vue.openBlock(true), vue.createElementBlock(
              vue.Fragment,
              null,
              vue.renderList($setup.ctrlItems, (item, index) => {
                return vue.openBlock(), vue.createElementBlock("view", {
                  class: "oled-control-row",
                  key: "oled-ctrl-" + index
                }, [
                  vue.createElementVNode("view", { class: "oled-control-info" }, [
                    vue.createElementVNode(
                      "text",
                      { class: "oled-text" },
                    ...
                    vue.createElementVNode(
                      "view",
                      {
                        class: vue.normalizeClass(["oled-status-dot", { "active": $setup.getCtrlItemStatus(item) }])
                      },
                      null,
                      2
                      /* CLASS */
                  ...
                  vue.createElementVNode("switch", {
                    ...
                    onChange: (e) => $setup.handleSwitchChange(e, item),
                    class: "oled-switch",
                    color: "#00ff00"
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__file", "C:/Users/Administrator/Desktop/hzk-mqs-GXAQDB基于stm32单片机的智能药箱系统的设计与实现/app/pages/index/index.vue"]]);
  const _sfc_main$3 = {
    __name: "history_data",
    setup(__props, { expose: __expose }) {
      __expose();
      const devices = vue.computed(() => {
        return Array.isArray(config.devices) ? config.devices : [];
      });
      const fieldLabels = vue.computed(() => {
        return ["请选择设备", ...devices.value.map((device) => device.label || "未知字段")];
      });
      const fieldKeys = vue.computed(() => {
        return [null, ...devices.value.map((device) => device.key || "")];
      });
      const selectedFieldIndex = vue.ref(0);
      const startDate = vue.ref("");
      const endDate = vue.ref("");
      const historyData = vue.ref([]);
      const hasQueried = vue.ref(false);
      const selectedField = vue.computed(() => {
      ...
      const queryHistory = () => {
        ...
        try {
          ...
          historyData.value = results.map((record) => ({
      ...
      const __returned__ = { devices, fieldLabels, fieldKeys, selectedFieldIndex, startDate, endDate, historyData, hasQueried, selectedField, onFieldChange, queryHistory, ref: vue.ref, computed: vue.computed, onMounted: vue.onMounted, get config() {
        return config;
      }, get historyManager() {
        return historyManager;
      } };
  ...
  function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "history-page" }, [
      vue.createElementVNode("view", { class: "sticky-container" }, [
        vue.createElementVNode("view", { class: "field-selector" }, [
          vue.createElementVNode("picker", {
            onChange: $setup.onFieldChange,
            value: $setup.selectedFieldIndex,
            range: $setup.fieldLabels
          }, [
            vue.createElementVNode(
              "view",
              { class: "picker-view" },
              " 选择设备: " + vue.toDisplayString($setup.fieldLabels[$setup.selectedFieldIndex] || "请选择"),
              1
              /* TEXT */
            )
          ], 40, ["value", "range"])
      ...
      $setup.historyData.length > 0 ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
        class: "history-list"
      }, [
        vue.createElementVNode("view", { class: "list-header" }, [
          vue.createElementVNode("view", { class: "col" }, "时间"),
          vue.createElementVNode("view", { class: "col" }, "数值"),
          vue.createElementVNode("view", { class: "col" }, "字段标识（key）")
        ]),
        (vue.openBlock(true), vue.createElementBlock(
          vue.Fragment,
          null,
          vue.renderList($setup.historyData, (item, index) => {
            return vue.openBlock(), vue.createElementBlock("view", {
              class: "list-item",
              key: index
            }, [
      ...
      $setup.historyData.length === 0 && $setup.hasQueried ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 1,
        class: "empty"
      }, [
        !$setup.selectedField ? (vue.openBlock(), vue.createElementBlock(
          vue.Fragment,
          { key: 0 },
          [
            vue.createTextVNode("请先选择查询字段")
          ],
          64
          /* STABLE_FRAGMENT */
          ...
          { key: 1 },
          [
            vue.createTextVNode("没有找到匹配的历史数据")
          ],
          64
          /* STABLE_FRAGMENT */
        ))
  ...
  const PagesHistoryDataHistoryData = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__file", "C:/Users/Administrator/Desktop/hzk-mqs-GXAQDB基于stm32单片机的智能药箱系统的设计与实现/app/pages/history_data/history_data.vue"]]);
  const _sfc_main$2 = {
    __name: "threshold_setting",
    setup(__props, { expose: __expose }) {
      __expose();
      const devices = vue.ref([]);
      const deviceLabels = vue.computed(() => devices.value.map((device) => device.label || "未知设备"));
      const selectedDeviceIndex = vue.ref(-1);
      const currentThreshold = vue.ref({ min: 0, max: 0 });
      const loading = vue.ref(false);
      const currentDevice = vue.computed(() => {
        if (devices.value.length === 0 || selectedDeviceIndex.value < 0)
          return null;
      ...
      vue.onMounted(() => {
        try {
          thresholdManager.initThresholds();
          if (Array.isArray(config.devices)) {
            devices.value = config.devices.filter(
              (device) => device && typeof device.key === "string"
            );
          }
          if (devices.value.length > 0) {
      ...
      vue.watch([selectedDeviceIndex, devices], () => {
      ...
      const __returned__ = { devices, deviceLabels, selectedDeviceIndex, currentThreshold, loading, currentDevice, loadThreshold, onDeviceChange, saveThreshold, ref: vue.ref, onMounted: vue.onMounted, computed: vue.computed, watch: vue.watch, get config() {
        return config;
      }, get thresholdManager() {
  ...
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "threshold-page" }, [
      vue.createElementVNode("view", { class: "sticky-container" }, [
        vue.createElementVNode("view", { class: "field-selector" }, [
          $setup.devices.length > 0 ? (vue.openBlock(), vue.createElementBlock("picker", {
            key: 0,
            onChange: $setup.onDeviceChange,
            value: $setup.selectedDeviceIndex,
            range: $setup.deviceLabels
          }, [
            vue.createElementVNode(
              "view",
              { class: "picker-view" },
              " 选择设备: " + vue.toDisplayString($setup.deviceLabels[$setup.selectedDeviceIndex] || "请选择"),
              1
              /* TEXT */
            )
      ...
      $setup.currentDevice ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
        ...
        vue.createElementVNode("view", { class: "device-info" }, [
          vue.createElementVNode("image", {
            class: "device-icon",
            src: $setup.currentDevice.icon,
            mode: "widthFix"
          }, null, 8, ["src"]),
          vue.createElementVNode(
            "view",
            { class: "device-name" },
            vue.toDisplayString($setup.currentDevice.label),
            1
            /* TEXT */
          )
        ]),
        vue.createElementVNode("view", { class: "threshold-controls" }, [
          vue.createElementVNode("view", { class: "threshold-item" }, [
            vue.createElementVNode("text", { class: "label" }, "最小值阈值"),
            vue.withDirectives(vue.createElementVNode(
              "input",
              {
                type: "number",
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $setup.currentThreshold.min = $event),
                class: "input"
              },
              null,
              512
          ...
          vue.createElementVNode("view", { class: "threshold-item" }, [
            vue.createElementVNode("text", { class: "label" }, "最大值阈值"),
            vue.withDirectives(vue.createElementVNode(
              "input",
              {
                type: "number",
                "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $setup.currentThreshold.max = $event),
                class: "input"
              },
              null,
              512
      ...
      !$setup.currentDevice && $setup.devices.length > 0 ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 1,
        class: "empty"
      }, " 请先选择设备 ")) : vue.createCommentVNode("v-if", true),
      $setup.devices.length === 0 ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 2,
        class: "empty"
      }, " 未配置任何设备 ")) : vue.createCommentVNode("v-if", true),
      $setup.currentDevice ? (vue.openBlock(), vue.createElementBlock("button", {
        key: 3,
        class: "save-btn",
        onClick: $setup.saveThreshold
      }, " 保存设置 ")) : vue.createCommentVNode("v-if", true)
    ]);
  }
  const PagesThresholdSettingThresholdSetting = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__file", "C:/Users/Administrator/Desktop/hzk-mqs-GXAQDB基于stm32单片机的智能药箱系统的设计与实现/app/pages/threshold_setting/threshold_setting.vue"]]);
  ...
  const _sfc_main$1 = {
    ...
    setup(__props, { expose: __expose }) {
      ...
      const triggerStatus = vue.ref(true);
      const timeTasks = vue.ref([]);
      ...
      const executeTimeTask = (task) => {
        ...
        if (!device)
          return;
        const rawMessage = task.status ? (_a2 = device.mqttConfig) == null ? void 0 : _a2.onMessage : (_b = device.mqttConfig) == null ? void 0 : _b.offMessage;
      ...
      const checkTimeTasks = () => {
        ...
        const tasksToExecute = timeTasks.value.filter(
          (task) => `${task.date} ${task.time}` === currentTimeStr
        );
        tasksToExecute.forEach((task) => {
          const delay = Math.floor(Math.random() * 1e3);
          setTimeout(() => {
            executeTimeTask(task);
            const taskIndex = timeTasks.value.findIndex(
              (t) => t.deviceKey === task.deviceKey && t.date === task.date && t.time === task.time && t.createdAt === task.createdAt
            );
            if (taskIndex !== -1) {
      ...
      vue.onMounted(() => {
        if (Array.isArray(config.devices_ctrl)) {
          devices.value = config.devices_ctrl.filter(
            (device) => device && typeof device.key === "string"
          );
        }
        loadTimeTasks();
        ...
        checkTimeTasks();
        setInterval(checkTimeTasks, 6e4);
      });
      const __returned__ = { STORAGE_KEY, devices, deviceLabels, selectedDeviceIndex, selectedDate, selectedTime, triggerStatus, timeTasks, padZero, loadTimeTasks, saveTimeTasks, executeTimeTask, checkTimeTasks, onDeviceChange, onDateChange, onTimeChange, onStatusChange, addTimeTask, deleteTask, getDeviceLabel, ref: vue.ref, onMounted: vue.onMounted, computed: vue.computed, get config() {
        return config;
      }, get mqtt_publish() {
        return mqtt_publish;
      } };
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "time-setting-page" }, [
      vue.createElementVNode("view", { class: "sticky-container" }, [
        vue.createElementVNode("view", { class: "field-selector" }, [
          $setup.devices.length > 0 ? (vue.openBlock(), vue.createElementBlock("picker", {
            key: 0,
        ...
        $setup.devices.length > 0 ? (vue.openBlock(), vue.createElementBlock("view", {
          ...
          vue.createElementVNode("view", { class: "time-input" }, [
            vue.createElementVNode("picker", {
              ...
              class: "date-picker"
            }, vue.toDisplayString($setup.selectedDate || "选择日期"), 41, ["value"]),
            vue.createElementVNode("picker", {
              mode: "time",
              value: $setup.selectedTime,
              start: "00:00",
              end: "23:59",
              onChange: $setup.onTimeChange,
              class: "time-picker"
            }, vue.toDisplayString($setup.selectedTime || "选择时间"), 41, ["value"])
          ]),
          vue.createElementVNode("view", { class: "status-selector" }, [
            vue.createElementVNode("text", { class: "status-label" }, "触发状态:"),
            vue.createElementVNode("switch", {
              checked: $setup.triggerStatus,
            ...
            vue.createElementVNode(
              "text",
              null,
              vue.toDisplayString($setup.triggerStatus ? "开启" : "关闭"),
              1
              /* TEXT */
            )
          ])
        ])) : vue.createCommentVNode("v-if", true),
        $setup.devices.length > 0 && $setup.selectedDeviceIndex !== -1 ? (vue.openBlock(), vue.createElementBlock("button", {
          key: 1,
          class: "add-btn",
          onClick: $setup.addTimeTask
        }, " 添加定时任务 ")) : vue.createCommentVNode("v-if", true)
      ]),
      $setup.timeTasks.length > 0 ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
        class: "task-list"
      }, [
        (vue.openBlock(true), vue.createElementBlock(
          vue.Fragment,
          null,
          vue.renderList($setup.timeTasks, (task, index) => {
            return vue.openBlock(), vue.createElementBlock("view", {
              class: "task-item",
              key: index
            }, [
              vue.createElementVNode("view", { class: "task-info" }, [
                vue.createElementVNode("view", { class: "task-device" }, [
                  vue.createTextVNode(
                    vue.toDisplayString($setup.getDeviceLabel(task.deviceKey)) + " ",
                    1
                    /* TEXT */
                  ),
                  vue.createElementVNode(
                    "span",
                    {
                      class: vue.normalizeClass(["task-status", task.status ? "status-on" : "status-off"])
                    },
                    vue.toDisplayString(task.status ? "开启" : "关闭"),
                    3
                    /* TEXT, CLASS */
                  )
                ]),
                vue.createElementVNode(
                  "view",
                  { class: "task-time" },
                  vue.toDisplayString(task.date) + " " + vue.toDisplayString(task.time),
                  1
                  /* TEXT */
                )
              ]),
      ...
      $setup.devices.length === 0 ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 1,
        class: "empty"
      }, " 未配置任何控制设备 ")) : vue.createCommentVNode("v-if", true),
      $setup.devices.length > 0 && $setup.timeTasks.length === 0 ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 2,
        class: "empty"
      }, " 暂无定时任务，请添加 ")) : vue.createCommentVNode("v-if", true)
    ]);
  }
  const PagesSetTimeSetTime = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "C:/Users/Administrator/Desktop/hzk-mqs-GXAQDB基于stm32单片机的智能药箱系统的设计与实现/app/pages/set_time/set_time.vue"]]);
  __definePage("pages/login/login", PagesLoginLogin);
  __definePage("pages/index/index", PagesIndexIndex);
  __definePage("pages/history_data/history_data", PagesHistoryDataHistoryData);
  __definePage("pages/threshold_setting/threshold_setting", PagesThresholdSettingThresholdSetting);
  __definePage("pages/set_time/set_time", PagesSetTimeSetTime);
  const _sfc_main = {
    onLaunch: async function() {
      async function initUserTable() {
        try {
          await DB.openSqlite();
          formatAppLog("log", "at App.vue:10", "数据库打开成功");
          ...
          if (userTableExists) {
            formatAppLog("log", "at App.vue:25", "用户表创建成功并已存在");
          } else {
            formatAppLog("error", "at App.vue:27", "用户表创建失败：表未被创建");
          }
        } catch (e) {
          formatAppLog("error", "at App.vue:30", "用户表初始化失败:", e.message || e);
        }
      }
      await initUserTable();
      formatAppLog("log", "at App.vue:36", "App Launch");
    },
    onShow: function() {
      formatAppLog("log", "at App.vue:39", "App Show");
    },
    onHide: function() {
      formatAppLog("log", "at App.vue:42", "App Hide");
    }
  };
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:/Users/Administrator/Desktop/hzk-mqs-GXAQDB基于stm32单片机的智能药箱系统的设计与实现/app/App.vue"]]);
  function createApp() {
  ...
  uni.connectSocket = /* @__PURE__ */ function(connectSocket) {
    return function(options) {
      formatAppLog("log", "at main.js:28", options);
